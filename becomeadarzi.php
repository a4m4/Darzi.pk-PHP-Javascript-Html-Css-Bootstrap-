...
<h1  style="font-family: 'Tangerine', cursive;  font-size: 90px;  color: white;  text-shadow: 2px 2px 4px #066c61;   float: left; margin-left: 16%;">  Become A Darzi  </h1>

<div style="margin-left: 6%; margin-right: 40%;">


<form method="post" action="becomeadarzi.php" enctype="multipart/form-data">
...
<br><br> <input class="form-control input-sm" style="color: #066c61;" type="submit" name="submit" value="Submit">
